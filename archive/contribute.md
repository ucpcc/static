...
1. Pull Request를 올려 주시기 바랍니다.
   `.github/PULL_REQUEST_TEMPLATE.md` 템플릿에 맞춰 변경 내용을 정리해 주시면, 임원진이 리뷰 후 머지하겠습니다.
   머지는 `Squash merge`만 사용합니다. 히스토리를 깔끔하게 유지하기 위함입니다.
2. 직접 PR을 열기 어렵다면 메일로 자료를 보내 주시기 바랍니다.
   아카이브 관련 문의 및 자료 전달 메일은 `archive@ucpc.me`입니다. 대회 자료를 메일로 보내 주시면 임원진이 확인 후 업로드하겠습니다.
...
2. 단체 설명을 적습니다.
3. 단체 정책에 맞는 라이선스 또는 저작권 고지 파일을 함께 추가합니다.
4. 필요하면 그 아래에 대회 디렉터리를 추가합니다.
5. `archive/index.md`에 새 단체 링크를 추가합니다.
